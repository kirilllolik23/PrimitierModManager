...
namespace PrimitierModManager
{
	public static class Updater
	{
		...
		private static void CreateGitHubClient()
		{
			...
			{
				s_gitHubClient = new GitHubClient(new ProductHeaderValue("kirilllolik23-PrimitierModManager", Assembly.GetEntryAssembly().GetName().Version.ToString()));
			}
		}
		...
		public static async Task<Release> GetLatestRelease()
		{
			...
			var releases = await s_gitHubClient.Repository.Release.GetAll("kirilllolik23", "PrimitierModManager");
